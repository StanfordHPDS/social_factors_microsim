...
This repository contains code for the paper "A novel decision-modeling framework for health policy analyses when outcomes are influenced by social and disease processes" by Marika Cusick, Fernando Alarid-Escudero, Jeremy Goldhaber-Fiebert, and Sherri Rose (2026), *Medical Decision Making*. [[Link]](https://journals.sagepub.com/doi/10.1177/0272989X251408817).
