...
| Out of health system | In health system | | `{python} params["pOI"]` |
...
| In health system[^4] | Adults with insurance |  | `{python} convert_to_percent(place_insured_prop)`% [@CDC2018]|
...
gt_ex = (
    ...
    .tab_source_note(source_note="MCSEs: Monte Carlo standard errors")
)
gt_ex
```
...
plt.xlabel('Age')
plt.savefig('figures/figure3a.eps', format='eps')
plt.savefig('figures/figure3a.png')
plt.show()
plt.close()
...
plt.ylabel('Prevalence')
plt.xlabel('Age')
plt.savefig('figures/figure3b.eps', format='eps')
...
plt.tight_layout()
plt.savefig('figures/figure4a.eps', format='eps')
plt.savefig('figures/figure4a.png')
plt.show()
plt.close()
...
plt.legend(handles=legend_elements, loc="upper left")
plt.savefig('figures/figure4b.eps', format='eps')
...
Modified parameters for sensitivity analysis alternative disease characteristics [^5]
:::

[^5]: Parameters were modified for both standard model and model with social factors framework
...
Modified parameters for sensitivity analysis of differential healthcare costs by insurance status [^6]
:::

[^6]: Parameters were only modified for the model with the social factors framework
